...
func main() {
	username := "admin"
	token := "704738acc6a62b2da4b02f49df55555463292111"
	filehash := "a6e3ab2cec6a2b1178a22712dc2dc548c16d1484"
	...
	// 3. 请求分块上传接口
	filename := "data/raftkv-master.zip"
